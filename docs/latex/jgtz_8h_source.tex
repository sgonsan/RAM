\doxysection{jgtz.\+h}
\hypertarget{jgtz_8h_source}{}\label{jgtz_8h_source}\index{Instructions/jgtz.h@{Instructions/jgtz.h}}

\begin{DoxyCode}{0}
\DoxyCodeLine{00001\ \textcolor{preprocessor}{\#ifndef\ JGTZ\_H}}
\DoxyCodeLine{00002\ \textcolor{preprocessor}{\#define\ JGTZ\_H}}
\DoxyCodeLine{00003\ }
\DoxyCodeLine{00004\ \textcolor{preprocessor}{\#include\ "{}../instruction.h"{}}}
\DoxyCodeLine{00005\ }
\DoxyCodeLine{00010\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classJgtz}{Jgtz}}\ :\ \textcolor{keyword}{public}\ \mbox{\hyperlink{classInstruction}{Instruction}}\ \{}
\DoxyCodeLine{00011\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{00012\ \ \ \mbox{\hyperlink{classJgtz}{Jgtz}}()\ \{\}}
\DoxyCodeLine{00013\ \ \ \mbox{\hyperlink{classJgtz}{Jgtz}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{string}\ \&line)\ \{}
...
\DoxyCodeLine{00036\ \ \ \ \ \ \ \textcolor{keywordflow}{throw}\ invalid\_argument(\textcolor{stringliteral}{"{}jgtz\ instruction\ must\ have\ 2\ operands"{}});}
...
\DoxyCodeLine{00064\ \ \ \}}
\DoxyCodeLine{00065\ }
\DoxyCodeLine{00066\ \ \ \textcolor{keywordtype}{string}\ getName()\textcolor{keyword}{\ const\ override\ }\{\ \textcolor{keywordflow}{return}\ \textcolor{stringliteral}{"{}jgtz"{}};\ \}}
\DoxyCodeLine{00067\ }
\DoxyCodeLine{00068\ \ \textcolor{keyword}{private}:}
\DoxyCodeLine{00069\ \ \ vector<Operand>\ operands\_;}
\DoxyCodeLine{00070\ \};}
\DoxyCodeLine{00071\ }
\DoxyCodeLine{00072\ \textcolor{preprocessor}{\#endif\ \ }\textcolor{comment}{//\ JGTZ\_H}}
